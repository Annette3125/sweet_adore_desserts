...
class Cake(models.Model):
    ...
    # by Ocasion, by Design, by Flavour
...
class Dessert(models.Model):
    cookie = models.ForeignKey(
        Cookie, on_delete=models.RESTRICT, blank=False, null=False
    )
    cake_pops = models.ForeignKey(
        CakePops, on_delete=models.RESTRICT, blank=False, null=False
    )
...
class Order(models.Model):
    desserts = models.ForeignKey(
        Dessert, on_delete=models.RESTRICT, blank=False, null=False
    )
